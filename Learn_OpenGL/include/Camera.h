...
public:
    ...
    glm::mat4 CustomLookAt(const glm::vec3& pos, const glm::vec3& target, const glm::vec3& up) const
    {
        ...
        glm::mat4 lookAtMat = rotMat * transMat;
        return lookAtMat;
    }
    ...
    {
        glm::vec3 front_mvmnt = FPS_MODE ? glm::vec3(Front.x, 0.0f, Front.z) : Front;
        float velocity = MovementSpeed * deltaTime;

        if (direction == FORWARD)
            Position += front_mvmnt * velocity;
